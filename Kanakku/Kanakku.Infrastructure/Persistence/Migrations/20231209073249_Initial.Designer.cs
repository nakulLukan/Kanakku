...
namespace Kanakku.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231209073249_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kanakku.Domain.Inventory.ProductWorkInstance", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_work_instances");

                    b.HasIndex("ProductInstanceId")
                        .HasDatabaseName("ix_product_work_instances_product_instance_id");

                    b.HasIndex("WorkId")
                        .HasDatabaseName("ix_product_work_instances_work_id");

                    b.ToTable("product_work_instances", (string)null);
                });
            ...
            modelBuilder.Entity("Kanakku.Domain.User.Designation", b =>
                {
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("ix_designations_name");
            ...
            modelBuilder.Entity("Kanakku.Domain.User.EmployeeSalaryHistory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_employee_salary_histories");

                    b.HasIndex("EmpId")
                        .HasDatabaseName("ix_employee_salary_histories_emp_id");

                    b.ToTable("employee_salary_histories", (string)null);
                });
            ...
            modelBuilder.Entity("Kanakku.Domain.Inventory.ProductWorkInstance", b =>
                {
                    b.HasOne("Kanakku.Domain.Inventory.ProductInstance", "ProductInstance")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_work_instances_product_instances_product_instance_id");
                    ...
                    b.HasOne("Kanakku.Domain.Inventory.Work", "Work")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_work_instances_works_work_id");
            ...
            modelBuilder.Entity("Kanakku.Domain.User.AppUser", b =>
                {
                    b.HasOne("Kanakku.Domain.Attachment.BinaryResource", "Image")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_asp_net_users_binary_resources_image_id");
            ...
            modelBuilder.Entity("Kanakku.Domain.User.EmployeeSalaryHistory", b =>
                {
                    b.HasOne("Kanakku.Domain.User.Employee", "Employee")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_employee_salary_histories_employees_employee_id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Kanakku.Domain.User.AppUser", null)
                        .WithMany()
