...
namespace Kanakku.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20221001111406_ProductWorkInstanceTableAdded")]
    partial class ProductWorkInstanceTableAdded
    {
            ...
            modelBuilder.Entity("Kanakku.Domain.Inventory.ProductWorkInstance", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_work_instance");

                    b.HasIndex("ProductInstanceId")
                        .HasDatabaseName("ix_product_work_instance_product_instance_id");

                    b.HasIndex("WorkId")
                        .HasDatabaseName("ix_product_work_instance_work_id");

                    b.ToTable("product_work_instance", (string)null);
                });
            ...
            modelBuilder.Entity("Kanakku.Domain.Inventory.ProductWorkInstance", b =>
                {
                    b.HasOne("Kanakku.Domain.Inventory.ProductInstance", "ProductInstance")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_work_instance_product_instances_product_instance_id");
                    ...
                    b.HasOne("Kanakku.Domain.Inventory.Work", "Work")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_work_instance_works_work_id");
